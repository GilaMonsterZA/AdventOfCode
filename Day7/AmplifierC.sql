...
DECLARE @Iteration INT, @EndIteration INT, @AmplifierCode CHAR(1) = 'C';
...
WHILE (@Iteration <= @EndIteration)
	BEGIN
		...
		SELECT @AmplifierCode, @Iteration+1, 1, PhaseC FROM AmplifierChecks WHERE Iteration = @Iteration+1
