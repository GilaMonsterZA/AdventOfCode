...
DECLARE @Iteration INT, @EndIteration INT, @AmplifierCode CHAR(1) = 'B';
...
WHILE (@Iteration <= @EndIteration)
	BEGIN
		...
		SELECT @AmplifierCode, @Iteration+1, 1, PhaseB FROM AmplifierChecks WHERE Iteration = @Iteration+1
